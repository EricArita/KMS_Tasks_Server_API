    ...
    public class Startup
    {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0.0", new OpenApiInfo
                    {
                        ...
                        Description = "KMS_Tasks Api Doc (ASP.NET Core 3.1)",
                    ...
                    c.DocumentFilter<BasePathFilter>("/KMS_Tasks/Api_Doc/1.0.0");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/1.0.0/swagger.json", "KMS_Tasks Api Doc");

                //TODO: Or alternatively use the original Swagger contract that's included in the static files
                // c.SwaggerEndpoint("/swagger-original.json", "KMS_Tasks Api Doc Original");
            });
